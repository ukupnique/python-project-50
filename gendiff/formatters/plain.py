...
def format_added_property(value, full_key):
    ...
    message = (f"Property '{full_key}' was added with value:"
               f" {value_description}")
    return message
